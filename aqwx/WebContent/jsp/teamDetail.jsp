...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<meta http-equiv="description" content="这个页面是关于我们公司技术精英的详细信息">
  ...
  <body>
    ...
    <div id="templatemo_main">
          ...
          <div class="col_w580 float_r">
          	...
          	<%-- <img src="${pageContext.request.contextPath}/images/team.jpg"/><div id="position">>>当前位置：精英团队</div> --%>
           	  <div class="post_box">
           	  		<div style="text-align: center;">
           	  		<a rel="lightbox[portfolio]" href="${pageContext.request.contextPath}${mp.teamDetail.image}" title="${mp.teamDetail.name}">
           	  		<img src="${pageContext.request.contextPath}${mp.teamDetail.image}" style="width:350px;height:500px;"/>
           	  		</a>
           	  		</div>
           	  		<div style="word-break:break-all;">
           	  			${mp.teamDetail.content}
           	  		</div>
	                <div class="cleaner"></div>
              </div>
            </div>
