...
<html>
  ...
  <body style="background-repeat: no-repeat;background-position: center;background: url('${pageContext.request.contextPath}/Images/background.jpg');">
			<div class="panelBar" style=" border-width:1px;">
							<ul class="toolBar">
								<li><span style="margin-left:-25px;">当前位置：友情链接管理>> 添加友情链接</span></li>
							</ul>
			</div>
			<div  class="pageContent">
				<form method="post" action="${pageContext.request.contextPath}/link/addLink" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
				  		<div class="pageFormContent nowrap" style="overflow-x:hidden" layoutH="56">
				  			<table style="margin-top:30px;margin-left:-10px;height:130px;">
								<tbody style="text-align:right;">
									 <tr class="nowrap"><td><label>友情链接名称：</label></td><td><input type="text" name="name" class="required" style="width:200px;" maxlength="600"/></td></tr>
									 <tr><td></td><td></td></tr>
									 <tr class="nowrap"><td><label>友情链接地址：</label></td><td><input type="text" name="link" class="required" style="width:200px;" maxlength="600"/></td></tr>
									 <tr class="nowrap">
										<td colspan="2">
