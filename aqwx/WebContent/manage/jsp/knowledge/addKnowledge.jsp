...
<html>
  ...
  <body style="background-repeat: no-repeat;background-position: center;background: url('${pageContext.request.contextPath}/Images/background.jpg');">
			<div class="panelBar" style=" border-width:1px;">
							<ul class="toolBar">
								<li><span style="margin-left:-25px;">当前位置：纹绣技术管理 >> 添加新技术</span></li>
							</ul>
			</div>
			<div  class="pageContent">
				<form method="post" action="${pageContext.request.contextPath}/knowledge/addKnowledge" class="pageForm required-validate"  onsubmit="return validateCallback(this, dialogAjaxDone);">
				  		<div class="pageFormContent nowrap" style="overflow-x:hidden" layoutH="56">
				  			<table style="margin-top:30px;margin-left:-30px;height:130px;">
								<tbody style="text-align:right;">
									  <tr class="nowrap"><td><label>技术名称：</label></td><td><input type="text" name="name" class="required" style="width:437px;" maxlength="600"/></td></td></tr>
									  <tr><td></td><td></td></tr>
									  <tr class="nowrap"><td><label>技术特色：</label></td><td><textarea class="required" name="content" rows="16" cols="70" ></textarea></td></tr>
									  <tr ><td></td><td></td></tr>
