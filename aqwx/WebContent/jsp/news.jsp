...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>新闻动态—阿奇纹绣</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="纹绣,阿奇,纹媚">
	<meta http-equiv="description" content="这个页面展示公司最近的新闻">
  ...
  <body>
     ...
     <div id="templatemo_menu">
        <ul style="width:1200px;margin-left:25px;">
           <li><a href="http://www.aqiwx.com">首页</a></li>
            ...
            <li><a href="${pageContext.request.contextPath}/news"  class="current">新闻动态</a></li>
    ...
    <div id="templatemo_main">
          ...
          <div class="col_w580 float_r">
          	<div style="width:650px;"><div style="float:left;"><img src="${pageContext.request.contextPath}/images/news.jpg"/></div><div id="position" style="float:right;">>>当前位置：新闻动态</div></div>
           	  <div class="post_box">
           	  		<%-- <ul class="tmo_list" style="word-break:break-all;">
						<c:forEach items="${mp.mp.list}" var="news">
							<li>>><a href="${pageContext.request.contextPath}/newsDetail?id=${news.id}">${news.name}</a><span style="float:right;">[${news.date }]</span></li>
							<div style="BORDER-TOP: silver 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div>
						</c:forEach>
					</ul> --%>
					<div style="word-break:break-all;width:650px;">
						<c:forEach items="${mp.mp.list}" var="news">
							<div style="width:650px;"><div class="new_div">>><a style="color:#000;font-weight:normal;"href="${pageContext.request.contextPath}/newsDetail?id=${news.id}">${news.name}</a></div><div class="float_r" style="height:12px;">[${news.date }]</div></div><div class="cleaner"></div>						
							<div style="BORDER-TOP: silver 1px dashed; OVERFLOW: hidden; HEIGHT: 1px;"></div>
						</c:forEach>
				</div>
					<div style="float:right;width:600px;text-align:right;">当前第${mp.mp.pageNum}页&nbsp;&nbsp;每页显示${mp.mp.numPerPage}条&nbsp;&nbsp;共${mp.mp.totalPage}页&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/news?pageNum=1">首页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/news?pageNum=${mp.mp.pageNum-1}">上一页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/news?pageNum=${mp.mp.pageNum+1}">下一页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/news?pageNum=${mp.mp.totalPage}">尾页</a></div>
	        		<!-- <a class="more" href="#">Full Post</a> -->
	                <div class="cleaner"></div>
              </div>
            </div>
            <div class="cleaner"></div>
