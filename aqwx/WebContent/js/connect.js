...
// k = "&nbsp;往&nbsp;&nbsp;事";
//}
suspendcode += " <img border='0' align='absmiddle' src='http://liunian.sturgeon.mopaas.com/images/qq/qqs_" + online[onlineP++] + ".gif' title='点击QQ与我们交流'/> " + k + "\n";
suspendcode += " </a>\n";
}
suspendcode += " </div>\n";
}
suspendcode = suspendcode + "</div>\n"
+ "<a title='关闭' id='toTop' href='javascript:void(0);' onclick='document.getElementById(\"contactContanier\").style.display=\"none\";'><img src='' width='122' height='17' style='border:0px' /></a>\n"
+ "</div>\n"
+ "</div>\n";
