  ...
  <body>
    ...
    <div id="templatemo_main">
          ...
          <div style="width:650px;"><div style="float:left;"><img src="${pageContext.request.contextPath}/images/news.jpg"/></div><div id="position" style="float:right;">>>当前位置：新闻动态</div></div>
          	<%-- <img src="${pageContext.request.contextPath}/images/news.jpg"/><div id="position">>>当前位置：新闻动态</div> --%>
           	  <div class="post_box">
           	  		<a rel="lightbox[portfolio]" href="${pageContext.request.contextPath}${mp.newsDetail.image}" title="${mp.newsDetail.name}">
           	  		<img src="${pageContext.request.contextPath}${mp.newsDetail.image}"/>
           	  		</a>
           	  		<div style="word-break:break-all;">
           	  			${mp.newsDetail.content }
           	  		</div>
	                <div class="cleaner"></div>
              </div>
            </div>
