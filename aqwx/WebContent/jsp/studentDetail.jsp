...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<meta http-equiv="description" content="这个页面是关于我们公司培训学员的详细信息">
          ...
          <div class="col_w580 float_r">
          	...
          	<%-- <img src="${pageContext.request.contextPath}/images/student.jpg"/><div id="position">>>当前位置：学员风采</div> --%>
           	  <div class="post_box">
           	  		...
           	  		<a rel="lightbox[portfolio]" href="${pageContext.request.contextPath}${mp.studentDetail.image}" title="${mp.studentDetail.name}">
           	  			<img src="${pageContext.request.contextPath}${mp.studentDetail.image}" style="width:350px;height:500px;"/>
           	  		</a>
           	  		</div>
           	  		<div style="word-break:break-all;">
           	  			${mp.studentDetail.content}
           	  		</div>
	                <div class="cleaner"></div>
              </div>
            </div>
