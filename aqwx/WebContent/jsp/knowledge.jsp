...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>专业知识—阿奇纹绣</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="纹绣,阿奇,纹媚">
	<meta http-equiv="description" content="这个页面是介绍公司所使用的专业知识">
  ...
  <body>
     ...
     <div id="templatemo_menu">
        <ul style="width:1200px;margin-left:25px;">
            ...
            <li><a href="${pageContext.request.contextPath}/knowledge"  class="current">专业知识</a></li>
    ...
    <div id="templatemo_main">
          ...
          <div style="width:650px;"><div style="float:left;"><img src="${pageContext.request.contextPath}/images/skill.jpg"/></div><div id="position" style="float:right;">>>当前位置：专业知识</div></div>
           	  <div class="post_box">
	        	<%-- <ul class="tmo_list" style="word-break:break-all;">
						<c:forEach items="${mp.mp.list}" var="knowledge">
							<li>>><a href="${pageContext.request.contextPath}/knowledgeDetail?id=${knowledge.id}">${knowledge.name}</a><span style="float:right;">[${knowledge.date }]</span></li>
							<div style="BORDER-TOP: silver 1px dashed; OVERFLOW: hidden; HEIGHT: 1px"></div>
						</c:forEach>
				</ul> --%>
				<div style="word-break:break-all;width:650px;">
						<c:forEach items="${mp.mp.list}" var="knowledge">
							<div style="width:650px;"><div class="new_div">>><a style="color:#000;font-weight:normal;"href="${pageContext.request.contextPath}/knowledgeDetail?id=${knowledge.id}">${knowledge.name}</a></div><div class="float_r" style="height:12px;">[${knowledge.date }]</div></div><div class="cleaner"></div>						
							<div style="BORDER-TOP: silver 1px dashed; OVERFLOW: hidden; HEIGHT: 1px;"></div>
						</c:forEach>
				</div>
				<div style="float:right;width:600px;text-align:right;">当前第${mp.mp.pageNum}页&nbsp;&nbsp;每页显示${mp.mp.numPerPage}条&nbsp;&nbsp;共${mp.mp.totalPage}页&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/knowledge?pageNum=1">首页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/knowledge?pageNum=${mp.mp.pageNum-1}">上一页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/knowledge?pageNum=${mp.mp.pageNum+1}">下一页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/knowledge?pageNum=${mp.mp.totalPage}">尾页</a></div>
	            <div class="cleaner"></div>
              </div>
            </div>
            <div class="cleaner"></div>
