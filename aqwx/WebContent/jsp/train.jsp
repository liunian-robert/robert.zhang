...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>培训加盟—阿奇纹绣</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="纹绣,阿奇,纹媚">
	<meta http-equiv="description" content="这个页面有关公司培训加盟的信息">
  ...
  <body>
     ...
     <div id="templatemo_menu">
        <ul style="width:1200px;margin-left:25px;">
            ...
            <li><a href="${pageContext.request.contextPath}/train" class="current">培训加盟</a></li>
    ...
    <div id="templatemo_main">
          ...
          <div style="width:650px;"><div style="float:left;"><img src="${pageContext.request.contextPath}/images/join_message.jpg"/></div><div id="position" style="float:right;">>>当前位置：培训加盟</div></div>
           	  <div class="post_box">
           	  	<a rel="lightbox[portfolio]" href="${pageContext.request.contextPath}${mp.join.image}" title="培训加盟">
	        		<img src="${pageContext.request.contextPath}${mp.join.image}"/>
	        	</a>
