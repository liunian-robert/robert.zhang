...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<meta http-equiv="description" content="这个页面是关于我们公司产品的详细信息">
  ...
  <body>
    ...
    <div id="templatemo_main">
          ...
          <div class="col_w580 float_r">
          	...
          	<%-- <img src="${pageContext.request.contextPath}/images/product_message.jpg"/><div id="position">>>当前位置：产品简介</div> --%>
           	  <div class="post_box">
           	  		<a rel="lightbox[portfolio]" href="${pageContext.request.contextPath}${mp.productDetail.image}" title="${mp.productDetail.name}">
           	  		<img src="${pageContext.request.contextPath}${mp.productDetail.image}"/>
           	  		</a>
           	  		<div style="word-break:break-all;">
           	  			${mp.productDetail.content}
           	  		</div>
	                <div class="cleaner"></div>
              </div>
            </div>
