...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>产品简介—阿奇纹绣</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="纹绣,阿奇,纹媚">
	<meta http-equiv="description" content="这个页面展示我们公司的产品">
  ...
  <body>
  	...
  	<div id="templatemo_wrapper">
       ...
       <!--  <div id="twitter"><a href="tencent://message/?uin=773970865" style="font-size:15px;"title="联系我们">联系我们</a></div>         -->
    </div>
     <div id="templatemo_menu">
        <ul style="width:1200px;margin-left:25px;">
            <li><a href="http://www.aqiwx.com">首页</a></li>
            <li><a href="${pageContext.request.contextPath}/about_us">关于我们</a></li>
            <li><a href="${pageContext.request.contextPath}/news">新闻动态</a></li>
            <li><a href="${pageContext.request.contextPath}/product" class="current">产品简介</a></li>
    ...
    <div id="templatemo_main">
			<div class="col_w900 col_w900_last">
            	<div class="col_w280 float_l">
                	...
                	<div class="lbe_box">
              		...
              		<div class="lbe_box" style="background-color: #F3F0E8;background-image: url('${pageContext.request.contextPath}/images/join.jpg');background-repeat: no-repeat;">
          ...
          <div class="col_w580 float_r">
          	 <div style="width:650px;"><div style="float:left;"><img src="${pageContext.request.contextPath}/images/product_message.jpg"/></div><div id="position" style="float:right;">>>当前位置：产品简介</div></div>
           	  <div class="post_box">
           	  		<c:forEach items="${mp.mp.list}" var="product">
           	  			<div class="IMG">
           	  			<a href="${pageContext.request.contextPath}/productDetail?id=${product.id}"><img src="${pageContext.request.contextPath}${product.image}"  style="width:170px;height:220px;margin-left:10px;"/> </a>
           	  			<a href="${pageContext.request.contextPath}/productDetail?id=${product.id}" style="width: 195px; text-overflow: ellipsis; text-align:center;margin-left:10px;margin-top:-15px;white-space: nowrap;
                                    overflow: hidden; float:left"> ${product.name }</a>
           	  			</div>
           	  		</c:forEach>
	        		<div style="float:right;width:600px;text-align:right;">当前第${mp.mp.pageNum}页&nbsp;&nbsp;每页显示${mp.mp.numPerPage}条&nbsp;&nbsp;共${mp.mp.totalPage}页&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/product?pageNum=1&&id=${mp.mp.id}">首页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/product?pageNum=${mp.mp.pageNum-1}&&id=${mp.mp.id}">上一页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/product?pageNum=${mp.mp.pageNum+1}&&id=${mp.mp.id}">下一页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/product?pageNum=${mp.mp.totalPage}&&id=${mp.mp.id}">尾页</a></div>
              </div>
               <div class="cleaner"></div>
            </div>
		</div>
