    ...
    <div id="templatemo_main">
			<div class="col_w900 col_w900_last">
            	<div class="col_w280 float_l">
	            	...
	            	<div  class="lbe_box">
	            				<div id="Marquee_z" style="width:248px;height:237px;">
          ...
          <div style="width:650px;"><div style="float:left;"><img src="${pageContext.request.contextPath}/images/about.jpg"/></div><div id="position" style="float:right;">>>当前位置：关于我们</div></div>
           	  <div class="post_box">
           	  		<img src="${pageContext.request.contextPath}${mp.company.image}"/>
