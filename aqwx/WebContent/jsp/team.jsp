...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>精英团队—阿奇纹绣</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="纹绣,阿奇,纹媚">
	<meta http-equiv="description" content="这个页面是介绍公司的技术团队成员">
  ...
  <body>
     ...
     <div id="templatemo_menu">
        <ul style="width:1200px;margin-left:25px;">
            ...
            <li><a href="${pageContext.request.contextPath}/team" class="current">精英团队</a></li>
    ...
    <div id="templatemo_main">
          ...
          <div class="col_w580 float_r">
          		<div style="width:650px;"><div style="float:left;"><img src="${pageContext.request.contextPath}/images/team.jpg"/></div><div id="position" style="float:right;">>>当前位置：精英团队</div></div>
           	  <div class="post_box">
	        		<c:forEach items="${mp.mp.list}" var="team">
           	  			<div class="IMG">
           	  			<a href="${pageContext.request.contextPath}/teamDetail?id=${team.id}"><img src="${pageContext.request.contextPath}${team.image}"  style="width:160px;height:220px;margin-left:10px;"/> </a>
           	  			<a href="${pageContext.request.contextPath}/teamDetail?id=${team.id}" style="width: 195px; text-overflow: ellipsis; text-align:center;margin-left:10px;margin-top:-15px;white-space: nowrap;
                                    overflow: hidden; float:left"> ${team.name }</a>
           	  			</div>
           	  		</c:forEach>
	        		<span style="float:right;width:600px;text-align: right;">当前第${mp.mp.pageNum}页&nbsp;&nbsp;每页显示${mp.mp.numPerPage}条&nbsp;&nbsp;共${mp.mp.totalPage}页&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/team?pageNum=1">首页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/team?pageNum=${mp.mp.pageNum-1}">上一页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/team?pageNum=${mp.mp.pageNum+1}">下一页</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/team?pageNum=${mp.mp.totalPage}">尾页</a></span>
              </div>
            </div>
		</div>
        <div class="cleaner"></div>
