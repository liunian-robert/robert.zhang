...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<meta http-equiv="description" content="这个页面是关于我们公司技术收费的详细信息">
  ...
  <body>
    ...
    <div id="templatemo_main">
          ...
          <div style="width:650px;"><div style="float:left;"><img src="${pageContext.request.contextPath}/images/skill.jpg"/></div><div id="position" style="float:right;">>>当前位置：专业知识</div></div>
          	<%-- <img src="${pageContext.request.contextPath}/images/skill.jpg"/><div id="position">>>当前位置：专业知识</div> --%>
           	  <div class="post_box">
           	  		<%-- <img src="${pageContext.request.contextPath}${mp.knowledge.image}"/> --%>
           	  		<div style="word-break:break-all;">
           	  			${mp.knowledgeDetail.content}
           	  		</div>
